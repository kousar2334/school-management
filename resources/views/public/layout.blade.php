...
<html>
<head>
<title>Dhunat N U Pilot High School </title>
<!--css-->
...
<link rel="stylesheet" href="{{asset('user/css/ken-burns.css')}}" type="text/css" media="all" />
<link rel="stylesheet" href="{{asset('user/css/animate.min.css')}}" type="text/css" media="all" />
<!--css-->
				...
				<!---Brand and toggle get grouped for better mobile display--->
						<div class="navbar-header">
							...
							<div class="navbar-brand">
								<h1><a href="index.html"><span>Dhunat N U Pilot High School</span></a></h1>
							</div>
						</div>
		...
		<div id="kb" class="carousel kb_elastic animate_text kb_wrapper" data-ride="carousel" data-interval="6000" data-pause="hover">
            ...
            <div class="carousel-inner" role="listbox">
                ...
                <div class="item active">
                    <img src="{{asset('user/images/banner1.jpg')}}" alt="" class="img-responsive" />
					...
					<div class="wel-grids">
						<div class="col-md-4 wel-grid">
							<div class="port-7 effect-2">
								<div class="image-box">
									<img src="{{asset('user/images/w1.jpg')}}" class="img-responsive" alt="Image-2">
								</div>
								<div class="text-desc">
									<h4>Studies</h4>
								</div>
